...
public class SharedPreferencesManager {
    ...
    */
    ...
    //保存登录信息
    public static void saveLoginInfo(Context context,String name,String password){
    ...
    //判断用户登录是否成功
    public static boolean LoginInfoIsSuccess(Context context,String name,String pass){
    ...
    public static String getUserName(Context context){
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences("loginInfo",Activity.MODE_PRIVATE);
        String string = sharedPreferences.getString("name", "未登录");
        return string;
    }
