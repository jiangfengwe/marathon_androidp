...
import com.tdin360.zjw.marathon.model.TravelCommentBean;
...
public class TravelCommentActivity extends BaseActivity {
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener=new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            if(Build.VERSION.SDK_INT<Build.VERSION_CODES.M){
                ...
                if(ActivityCompat.checkSelfPermission(TravelCommentActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
                    ActivityCompat.requestPermissions(TravelCommentActivity.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},82);
                }else {
                    initPic();
                }
            }
    ...
    private void initPic() {
        PictureSelector.create(TravelCommentActivity.this)
        ...
        switch(requestCode) {
            ...
            case 82:
                if(grantResults.length>0&&grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    ...
                    //用户没有授权
                    android.support.v7.app.AlertDialog.Builder alert = new android.support.v7.app.AlertDialog.Builder(TravelCommentActivity.this);
                    alert.setTitle("提示");
                    alert.setMessage("你需要设置权限才可以使用该功能");
                    alert.setPositiveButton("去设置", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            getAppDetailSettingIntent(TravelCommentActivity.this);
                        }
                    });
                    alert.show();
    ...
    private void initData() {
        ...
        RequestParams params=new RequestParams(HttpUrlUtils.Travel_ORDER_COMMENT);
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                Log.d("travelcomment", "onSuccess: "+result);
                Gson gson=new Gson();
                TravelCommentBean travelCommentBean = gson.fromJson(result, TravelCommentBean.class);
                boolean state = travelCommentBean.isState();
                if(state){
                    //ToastUtils.showCenter(getApplicationContext(),travelCommentBean.getMessage());
                    showDialog();
    ...
    public int getLayout() {
        //R.layout.activity_travel_comment;
