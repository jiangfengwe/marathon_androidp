...
import com.tdin360.zjw.marathon.utils.db.service.NoticeMessageService;
...
public class NoticeMessageServiceImpl implements NoticeMessageService {
    ...
    public NoticeMessageServiceImpl(Context context){
    ...
    public void addNotice(NoticeMessageModel model) {
        ...
        writableDatabase.insert(SQLHelper.NOTICE_MESSAGE_TABLE,null,values);
    ...
    public boolean deleteNotice(int id) {
        ...
        int delete = database.delete(SQLHelper.NOTICE_MESSAGE_TABLE, "id=?", new String[]{id+""});
        if(delete>0){
    ...
    public boolean deleteAllNotice() {
        ...
        int delete = database.delete(SQLHelper.NOTICE_MESSAGE_TABLE,null,null);
        if(delete>0){
    ...
    public List<NoticeMessageModel> getAllNotice() {
        ...
        Cursor cursor = database.query(SQLHelper.NOTICE_MESSAGE_TABLE, null, null, null, null, null,"id DESC");
